...
def pitcher_situation_work(pitcher_ID_tuple : tuple, attempt : int):
    '''
    ...
    try:
        ...
        if attempt < MAX_RETRIES:
            ...
            pitcher_situation_work(pitcher_ID_tuple=pitcher_ID_tuple, attempt=attempt+1)
        else:
...
if __name__ == "__main__":
    try:
        ...
        for i in range(0, NUM_PROCESS):
            if i == NUM_PROCESS-1 : 
                process_list.append(Process(target=pitcher_situation_work, args=(pitcher_number_list[split_index*i:],1)))
            else : 
                process_list.append(Process(target=pitcher_situation_work, args=(pitcher_number_list[split_index*i:split_index*(i+1)],1)))
